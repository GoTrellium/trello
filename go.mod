module github.com/GoTrellium/trello

go 1.17

require (
	github.com/GoTrellium/integram v0.0.0-20220224184129-bbfaf058d178
	github.com/integram-org/trello v0.0.0-20190329124903-85e16c30d9dd
